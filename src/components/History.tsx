      ...
      <div className="bg-white px-6 pt-12 pb-4 shadow-sm border-b border-slate-200 sticky top-0 z-10">
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${!filterUser ? 'bg-indigo-600 text-white shadow-md' : 'bg-slate-100 text-slate-600'}`}
          >
            Todos
          </button>
          {users.map(u => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors flex items-center gap-2 ${filterUser === u.id ? 'bg-slate-800 text-white shadow-md' : 'bg-slate-100 text-slate-600'}`}
            >
                      ...
                      >
                        ...
                        <div className="text-right flex items-center gap-3 shrink-0">
                          ...
                          <button 
                            ...
                            className="p-2 text-rose-500 bg-rose-50 rounded-full opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
                          >
                            <Trash2 size={16} />
                          </button>
                        </div>
